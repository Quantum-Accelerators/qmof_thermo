...
df_plot1 = df[
    ["formation_energy", "synthesizable", "chemsys", "frac_composition"]
].copy()
...
ax1.set_ylabel(r"Δ$E_{\mathrm{form}}$ (eV/atom)", fontsize=10)
...
ax2.legend(
    title="Synthesized", fontsize=9, title_fontsize=9, frameon=False, loc="upper right"
)
