...
if len(differences_below) > 0:
    ...
    n1, bins1, patches1 = ax1.hist(differences_below, bins=12, weights=weights1,
                                    color='#6495ED', edgecolor='black', alpha=0.7)
    ax1.set_xlabel('Nonzero ΔΔ$E_{\mathrm{hull}}$ (eV/atom)\nMP$_{\mathrm{within}}$ $_{0.000}$ $_{\mathrm{eV/atom}}$ → MP$_{\mathrm{within}}$ $_{0.005}$ $_{\mathrm{eV/atom}}$', fontsize=14)
...
if len(differences_above) > 0:
    ...
    n2, bins2, patches2 = ax2.hist(differences_above, bins=12, weights=weights2,
