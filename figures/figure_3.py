...
ax.tick_params(which="major", direction="in", length=15, width=1.25)
ax.tick_params(which="minor", direction="in", length=8, width=1.25)
...
plt.xlabel(r"$ΔE_{\mathrm{hull}}$ (eV/atom)", fontsize=10)
