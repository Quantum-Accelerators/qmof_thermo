...
ax2.text(-0.195, 1.0, "A", transform=ax2.transAxes, fontsize=11,
...
ax1.scatter(df["pore_diameters"], df["ehull"], c=colors_all, s=4, alpha=0.3, edgecolors='none')
...
ax1.text(-0.165, 1.0, "B", transform=ax1.transAxes, fontsize=11,
         fontweight="bold", va="top", ha="left")
