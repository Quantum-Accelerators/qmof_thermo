...
metal_list = ['Ag', 'Al', 'Au', 'Ba', 'Be', 'Bi', 'Ca', 'Cd', 'Ce', 'Co', 'Cr', 'Cs', 'Cu', 'Dy', 'Er', 'Eu', 'Fe', 'Ga', 'Gd', 'Hf', 'Hg', 'Ho', 'In', 'Ir', 'K', 'La', 'Li', 'Lu', 'Mg', 'Mn', 'Mo', 'Na', 'Nb', 'Nd', 'Ni', 'Np', 'Pb', 'Pd', 'Pr', 'Pt', 'Pu', 'Rb', 'Re', 'Rh', 'Ru', 'Sc', 'Sm', 'Sn', 'Sr', 'Tb', 'Tc', 'Th', 'Ti', 'Tl', 'Tm', 'U', 'V', 'W', 'Y', 'Yb', 'Zn', 'Zr', 'B', 'As', 'Sb', 'At', 'Te', 'Si', 'Ge']
...
# Save to CSV
median_ehull_by_metal.to_csv("single_metal_median_ehull_filtered.csv", index=False, header=False)
print("\nSaved results to 'single_metal_median_ehull_filtered.csv'")

# Optional: Also create a version with additional statistics
detailed_stats = df_filtered.groupby("group")["ehull"].agg([
    'count', 'median', 'mean', 'std', 'min', 'max'
]).reset_index()
detailed_stats.columns = ["Element", "Count", "Median_Ehull", "Mean_Ehull", "Std_Ehull", "Min_Ehull", "Max_Ehull"]
...
print("Also saved detailed statistics to 'single_metal_detailed_ehull_stats_filtered.csv'")
