...
elements = ["H", "O", "N"]
labels = ["A", "B", "C"]
element_names = {"H": "Hydrogen", "O": "Oxygen", "N": "Nitrogen"}
...
for row, (mol, label) in enumerate(zip(elements, labels, strict=False)):
    ...
    ax_left.set_ylabel(r"Δ$E_{\mathrm{form}}$ (eV/atom)", fontsize=18)
    ...
    ax_right.set_ylabel(r"Δ$E_{\mathrm{hull}}$ (eV/atom)", fontsize=18)
